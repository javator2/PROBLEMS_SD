...
class ProblemsTest {
    ...
    public void shouldFindSecondLastElementFromAList() throws Exception {
        List<Integer> numbers = asList(1, 2, 11, 4, 5, 8, 10);
        assertThat(Problems.secondLast(numbers), is(equalTo(8)));
    }
    ...
    public void shouldReverseAList() throws Exception {
        List<Integer> numbers = Arrays.asList(2,4,8,10,12);
        assertThat(Problems.reverse(numbers), is(equalTo(Arrays.asList(12,10,8,4,2))));
    }
